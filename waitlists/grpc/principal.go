...
// service.
//
// Unlike every other surface in this module, an extractor here reports "nobody"
// on requests that are working exactly as intended: three of this service's RPCs
// are a signup page, and the person on it has not signed in. See
// [Server.NewServer] and the package documentation.
