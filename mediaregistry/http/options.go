...
type Caller struct {
	...
	// mediaregistry.Object.OwnerID is, since comparing the two is what OwnerOnly
	// does.
	PrincipalID string
...
type (
	...
	// supplies its own, and gets the row to decide from: mediaregistry.Object
	// carries the owner, the scope, and the subject the object is attached to.
	Entitlement func(ctx context.Context, caller Caller, object *mediaregistry.Object) (bool, error)
)
...
// mediaregistry.Object refuses to validate without an owner, so an empty OwnerID is
...
func OwnerOnly(_ context.Context, caller Caller, object *mediaregistry.Object) (bool, error) {
