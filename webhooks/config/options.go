...
func WithDispatcherOptions(opts ...webhooks.DispatcherOption) Option {
	return func(o *options) { o.dispatcher = append(o.dispatcher, opts...) }
}

// WithWorkerOptions passes opts to NewWorker, which applies them after the options it
// derives from configuration — so a caller can override anything. The other
// constructors ignore them.
func WithWorkerOptions(opts ...webhooks.WorkerOption) Option {
