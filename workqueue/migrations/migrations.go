/*
Package migrations supplies the work queue table's DDL, rendered for a dialect
and table prefix.
...
repository, nothing to keep in sync as this package evolves:
	...
	ddl, err := migrations.SQL(dialect.Postgres, workqueue.DefaultTablePrefix)
	// ...
...
are binary strings and its claim index leads with completion instead of
filtering on it; SQLite has no clock finer than a second except strftime's %f,
