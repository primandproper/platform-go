...
type Querier interface {
	// ClaimOutboxMessages runs the :exec query.
	ClaimOutboxMessages(ctx context.Context, db DBTX, arg ClaimOutboxMessagesParams) error
	// FetchClaimedOutboxMessages runs the :many query.
