...
// MarkOutboxMessagesPublished runs the :exec query against sqlite.
func (q *sqliteQueries) MarkOutboxMessagesPublished(ctx context.Context, db DBTX, arg MarkOutboxMessagesPublishedParams) error {
