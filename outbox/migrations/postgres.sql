...
-- Serves the quarantine reaper and the operator read beside it. Quarantined
-- rows are a small minority of a healthy table and none at all of a healthy
-- one, so the partial clause is what keeps this index the size of the problem
