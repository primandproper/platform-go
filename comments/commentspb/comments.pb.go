...
type ListRootCommentsRequest struct {
	...
	// instruction: the rows it reaches are comments a moderator removed, and the
	// field is honored only for a caller holding comments.archive and cleared
	// for everybody else. See the file comment.
...
type ListRepliesRequest struct {
	...
	// filter pages the result. Its include_archived is a request rather than an
	// instruction: the rows it reaches are replies a moderator removed, and the
	// field is honored only for a caller holding comments.archive and cleared
	// for everybody else. See the file comment.
