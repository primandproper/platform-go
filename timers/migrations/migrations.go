...
One table holds every logical timer set: timers.Config.Name is the leading
...
// It is what you hand to database/migrate's WithGeneratedMigration, so the timer
