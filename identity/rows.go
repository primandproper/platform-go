...
// store knows what the stored address was. Taking the digest from the User would
...
func updateUserParams(u *User, verifiedAt *time.Time, digest string) identitydb.UpdateUserParams {
