...
type CreateAccountRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	OwnerRoles    []string               `protobuf:"bytes,2,rep,name=owner_roles,json=ownerRoles,proto3" json:"owner_roles,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateAccountRequest) GetOwnerRoles() []string {
	if x != nil {
		return x.OwnerRoles
	}
	return nil
...
type SetUserRequiresPasswordChangeRequest struct {
	state  protoimpl.MessageState `protogen:"open.v1"`
	UserId string                 `protobuf:"bytes,1,opt,name=user_id,json=userID,proto3" json:"user_id,omitempty"`
	...
	RequiresPasswordChange *bool `protobuf:"varint,2,opt,name=requires_password_change,json=requiresPasswordChange,proto3,oneof" json:"requires_password_change,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *SetUserRequiresPasswordChangeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SetUserRequiresPasswordChangeRequest) GetRequiresPasswordChange() bool {
	if x != nil && x.RequiresPasswordChange != nil {
		return *x.RequiresPasswordChange
	}
	return false
}

type SetUserRequiresPasswordChangeResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	User          *User                  `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *SetUserRequiresPasswordChangeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_primandproper_platform_identity_v1_identity_proto_rawDesc = "" +
	...
	"\vowner_roles\x18\x02 \x03(\tR\n" +
	"ownerRolesR\x05scopeR\rowner_user_id\"^\n" +
	"\x15CreateAccountResponse\x12E\n" +
	"\aaccount\x18\x01 \x01(\v2+.primandproper.platform.identity.v1.AccountR\aaccount\"r\n" +
	...
	"\x04user\x18\x01 \x01(\v2(.primandproper.platform.identity.v1.UserR\x04user\"\xa2\x01\n" +
	"$SetUserRequiresPasswordChangeRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userID\x12=\n" +
	"\x18requires_password_change\x18\x02 \x01(\bH\x00R\x16requiresPasswordChange\x88\x01\x01B\x1b\n" +
	"\x19_requires_password_changeR\x05scope\"e\n" +
	"%SetUserRequiresPasswordChangeResponse\x12<\n" +
	...
	"\x10CancelInvitation\x12;.primandproper.platform.identity.v1.CancelInvitationRequest\x1a<.primandproper.platform.identity.v1.CancelInvitationResponse\x12\x84\x01\n" +
	"\rCreateAccount\x128.primandproper.platform.identity.v1.CreateAccountRequest\x1a9.primandproper.platform.identity.v1.CreateAccountResponse\x12\xa5\x01\n" +
	...
	"\x13SetUserServiceRoles\x12>.primandproper.platform.identity.v1.SetUserServiceRolesRequest\x1a?.primandproper.platform.identity.v1.SetUserServiceRolesResponse\x12\xb4\x01\n" +
	"\x1dSetUserRequiresPasswordChange\x12H.primandproper.platform.identity.v1.SetUserRequiresPasswordChangeRequest\x1aI.primandproper.platform.identity.v1.SetUserRequiresPasswordChangeResponse\x12\x81\x01\n" +
