...
func UserToProto(u *identity.User) *identitypb.User {
	...
	return &identitypb.User{
		...
		EmailAddressVerificationTokenExpiresAt: timePointerToProto(u.EmailAddressVerificationTokenExpiresAt),
...
func UserFromProto(u *identitypb.User) *identity.User {
	...
	return &identity.User{
		...
		EmailAddressVerificationTokenExpiresAt: timePointerFromProto(u.GetEmailAddressVerificationTokenExpiresAt()),
