...
type options struct {
	...
	databaseStore []webauthnsessions.Option
...
//
//	webauthnsessionscfg.NewRelyingParty(ctx, cfg, db,
//	    webauthnsessionscfg.WithPillars(pillars),
//	    webauthnsessionscfg.WithMetricsProvider(nil), // these ceremonies stay unmetered
//	)
...
// provider.
func WithDatabaseStoreOptions(opts ...webauthnsessions.Option) Option {
