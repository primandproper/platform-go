/*
Command queriesgen writes the canonical sqlc input for the WebAuthn ceremony
session schema, one file per dialect, from
authentication/webauthncredentials/internal/queries.
...
authentication/webauthncredentials/migrations renders, at build time, with no
