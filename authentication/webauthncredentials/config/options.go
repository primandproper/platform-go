...
type options struct {
	...
	databaseStore []webauthncredentials.Option
...
//
//	webauthncredentialscfg.NewRelyingParty(ctx, cfg, db,
//	    webauthncredentialscfg.WithPillars(pillars),
//	    webauthncredentialscfg.WithMetricsProvider(nil), // these ceremonies stay unmetered
//	)
...
// provider.
func WithDatabaseStoreOptions(opts ...webauthncredentials.Option) Option {
