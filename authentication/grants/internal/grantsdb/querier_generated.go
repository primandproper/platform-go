...
type Querier interface {
	// ArchiveGrant runs the :execrows query.
	//
	...
	// The count means different things on different engines; see the note
	// on Querier.
	DeleteGrantsForSubject(ctx context.Context, db DBTX, arg DeleteGrantsForSubjectParams) (int64, error)
	// GetGrant runs the :one query.
	GetGrant(ctx context.Context, db DBTX, arg GetGrantParams) (GetGrantRow, error)
	// GetGrantForProvider runs the :one query.
	GetGrantForProvider(ctx context.Context, db DBTX, arg GetGrantForProviderParams) (GetGrantForProviderRow, error)
	// GetRevokedGrant runs the :one query.
	...
	// The count means different things on different engines; see the note
	// on Querier.
	RefreshGrant(ctx context.Context, db DBTX, arg RefreshGrantParams) (int64, error)
	// RevokeGrant runs the :execrows query.
	//
	// The count means different things on different engines; see the note
	// on Querier.
	RevokeGrant(ctx context.Context, db DBTX, arg RevokeGrantParams) (int64, error)
}
