/*
Command queriesgen writes the canonical sqlc input for the sign-in recovery code
schema, one file per dialect, from
authentication/signin/recoverycodes/internal/queries.
...
authentication/signin/recoverycodes/migrations renders, at build time, with no
