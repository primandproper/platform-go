/*
Command queriesgen writes the canonical sqlc input for the sign-in sign-in link
schema, one file per dialect, from
authentication/signin/magiclinks/internal/queries.
...
authentication/signin/magiclinks/migrations renders, at build time, with no
