...
func TestConfig_EnsureDefaults(t *testing.T) {
	...
	cfg := &Config{}
	cfg.EnsureDefaults()
	test.EqOp(t, billing.DefaultTablePrefix, cfg.TablePrefix)
...
func TestNewStore(T *testing.T) {
	...
	T.Run("the clock stays an option rather than environment", func(t *testing.T) {
		t.Parallel()

		// The clock decides which subscriptions are current, and a deployment
